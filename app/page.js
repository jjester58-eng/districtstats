...
export default function SchoolPage({ params }) {
    ...
    // ✅ Added missing uploadRoster function
    ...
    // ✅ Now uses your insert_player_stat RPC instead of hardcoded school_id
    async function savePlayerStats(e) {
        ...
        // Use the RPC function which auto-resolves school_id from auth
